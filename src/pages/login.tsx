...
import img1 from "../assets/button-img.svg";
    ...
    <div className="flex bg-fuchsia-700 items-center justify-center min-h-screen">
        {currentUser ? (
            <div className='flex flex-col items-center'>
                ...
                <h2 className="text-white text-3xl font-bold">Welcome {currentUser.name}</h2>
                <button className='bg-white text-fuchsia-700 px-4 py-2 mt-4 rounded-md hover:bg-slate-200' onClick={handleLogout}>Logout</button>
            </div>
